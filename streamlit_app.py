...
#             # Save dataframe and counts to session state
...
#         if st.confirm("Are you sure you want to clear all rows?"):
#             st.session_state.dataframe = pd.DataFrame()  # Clear the dataframe
#             st.session_state.uptodate_count = 0
#             st.session_state.overdue_count = 0
#             st.session_state.expiring_soon_count = 0
...
#                 st.success("All rows cleared and database updated!")
#             else:
#                 st.error(f"Failed to clear database: {clear_response.json()}")
